...
def compara_energia_controlavel(data_ini, caminho_TesteBase, caminho_testes_eco):

    df_controlavel_pmo = leitura_energia_controlavel_bloco_ano(caminho_TesteBase, data_ini, "***ENERGIA CONTROLAVEL***", "***RESERVATORIO EQUIVALENTE DE ENERGIA***")
    ...
    configuracao = 113
    df_controlavel_pmo_config = df_controlavel_pmo.loc[(df_controlavel_pmo["configuracao"] == configuracao)].reset_index(drop=True)
